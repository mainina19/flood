...
public class Coord implements Comparable<Coord> {
  ...
  /**
   * 
   * for my hashcode I use the bijective algorithm described in http://www.lsi.upc.edu/~alvarez/calculabilitat/enumerabilitat.pdf  
   ...
   */
  public int hashCode() {
    return (int) (x + Math.pow((y + ((x + 1)/2)), 2));
  }
